...
export function Customize() {
  ...
  const templatePreviewData = {
    ...
    photos: (formData.photos || []).map((p) => (typeof p === 'string' ? p : p.url)),
    photoObjects: (formData.photos || []).map((p) => (typeof p === 'string' ? { url: p, caption: '' } : { url: p.url, caption: p.caption || '' })),
    memories: (formData.photos || []).map((p) => (typeof p === 'string' ? { image: p, src: p, caption: '' } : { image: p.url, src: p.url, caption: p.caption || '' })),
